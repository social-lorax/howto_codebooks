...
```{r echo = FALSE}
tibble(id = c(1,2,3,4,5,6),
       name = c("elisabeth", "mike", "thea", "thomas", "oliver", "kate"),
       login = c("elismith", "mikey", "teatime", "tomatotom", "olivander", "katebenn")) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(id = c(1012,1004,1020,1014),
       tweat_id = c(87,49,77,77),
       user_id = c(1,1,1,1),
       message = c("awesome! thanks!", "this is fabulous!", "couldn't be better", "saved my day")) %>% 
  output()
```
...
```{python echo = FALSE}
print(['Album', 'Artist', 'Customer', 'Employee', 'Genre', 'Invoice', 'InvoiceLine', 'MediaType', 'Playlist', 'PlaylistTrack', 'Track'])
```
...
```{python echo = FALSE}
pd.DataFrame({"AlbumId": [1,2,3,4,5],
              "Title": ["For Those About To Rock We Salute You","Balls to the Wall", "Restless and Wild", "Let There Be Rock", "Big Ones"],
              "ArtistId": [1,2,2,1,3]})
```
...
```{r echo = FALSE}
tibble(avg_column = 5.5,
       max_column = 10,
       min_column = 1,
       range_column = 9,
       std_dev_column = 3.02765) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(lower = c(30, 35, 40, 45, 50, 55, 60),
       upper = c(35, 40, 45, 50, 55, 60, 65),
       count = c(0, 74, 155, 39, 445, 35, 0)) %>% 
  output()
```
<br>
...
```{r echo = FALSE}
tibble(corr_column1_column2 = 0.02) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(measure = c("column1", "column2", "column3"),
       column1 = c(1.00, 0.02, 0.02),
       column2 = c(0.02, 1.00, -0.09),
       column3 = c(0.02, -0.09, 1.00)) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(category = c("Apple", "banana", "apple", "Banana", " apple"),
       count = c(4, 3, 2, 1, 1)) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(category = c("apple", "banana", " apple"),
       count = c(6, 4, 1)) %>% 
  output()
```
<br>
...
```{r echo = FALSE}
tibble(category = c("Apple", "banana", "apple", "Banana"),
       count = c(4, 3, 3, 1)) %>% 
  output()
```
<br>
...
```{r echo = FALSE}
tibble(category = c("apple", "banana"),
       count = c(7,4)) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(day = c("Sunday", "Monday", "Tuesday", "Wednesday", " Thursday", "Friday", "Saturday")) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(daytime = "2020-01-21 18:39:00",
...
```{r echo = FALSE}
tibble(hour = c("2020-01-21 08:00:00", "2020-01-21 10:00:00", "2020-01-21 11:00:00", "2020-01-21 14:00:00"),
       count = c(22,33,44,55)) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(hour = c("2020-01-21 08:00:00", "2020-01-21 09:00:00", "2020-01-21 10:00:00", "2020-01-21 11:00:00", "2020-01-21 12:00:00", "2020-01-21 13:00:00", "2020-01-21 14:00:00"),
       count = c(22,0,33,44,0,0,55)) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(hour = c("2020-01-21 09:00:00", "2020-01-21 12:00:00", "2020-01-21 13:00:00")) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(datetime = c("2018-04-23 00:01:00", "2018-04-23 12:01:00", "2018-04-24 00:01:00", "2018-04-24 12:01:00"),
       lag = c(NA_character_, "2018-04-23 00:01:00", "2018-04-23 12:01:00", "2018-04-24 00:01:00"),
       lead = c("2018-04-23 12:01:00", "2018-04-24 00:01:00", "2018-04-24 12:01:00", NA_real_)) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(datetime = c("2018-04-23 00:01:00", "2018-04-23 12:01:00", "2018-04-24 00:01:00", "2018-04-24 12:01:00"),
       amount = c(31,12,18,13),
       pre_amount = c(NA_real_, 31, 12, 18),
       change = c(NA_real_, -19, 6, -5)) %>% 
  output()
```
...
```{r echo = FALSE}
tibble(user_id = c(1,2,3,4,5,6,7),
       Excited = c(2,0,0,1,0,2,2),
       Question = c(0,0,1,0,0,0,0))
```
...
```{r echo = FALSE}
tibble(tweat_id = c(49,75,77,87,88),
       Excited = c(0.33, 1.00, 0.50, 1.00, 0.50),
       Question = c(0.33, 0.00, 0.00, 0.00, 0.00))
```
